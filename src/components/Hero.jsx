  ...
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
      <motion.div
        ...
        <img className='w-20' src={assets.group_profile} draggable={false} />
      ...
      initial={{ opacity: 0, y: 40 }}
        ...
        <span className='bg-linear-to-r from-[#5044E5] to-[#4d8cea] bg-clip-text text-transparent'> digital </span>
        impact.
      </motion.div>
      <motion.div 
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
      className='relative'>
        <img src={assets.hero_img} className='w-full max-w-6xl' draggable={false} />
        <img src={assets.bgImage1} className='absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden' draggable={false} />
      </motion.div>
    </div>
  )
}
